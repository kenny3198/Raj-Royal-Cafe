                ...
                <form className='space-y-6'>
                    <div>
                        ...
                        <input type="text" id='name' name='name' placeholder='Your Name'
                            className='w-full px-4 py-2 border borde-gray-300 rounded-lg 
                    ...
                    <button className='w-full py-2 px-4 bg-amber-900 text-white 
                    font-semibold rounded-lg shadow-md
                     hover:bg-amber-950 transition duration-300'>Send Message</button>
                </form>
                <div className='mt-8 text-center'>
                    <p className='text-gray-600'>Or reach us directly:</p>
                    <p className='font-semibold text-black'>09049792566</p>
                    <p className='font-semibold text-black'>rajroyalcafe247@gmail.com</p>
                </div>
            </motion.div>
        </div>
    )
