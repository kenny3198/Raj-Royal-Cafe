...
const Hero = () => {
  return (
    <div className='from-slate-100 to-amber-950 bg-gradient-to-r mt-14'>
        <div className='max-w-7xl mx-auto grid md:grid-cols-2
         place-items-center h-[700px] md:h-[650px] pt-10 md:px-0'>
            {/* text-section */}
 ...
 className='text-amber-1000 font-semibold text-3xl'>Welcome to Raj Royal Cafe</motion.h3>
                <motion.h1 
                     ...
                     initial={{opacity:0,x:-60}}
                     whileInView={{opacity:1,x:0}}
                     transition={{duration:1.2, delay:0.6}}>Indulge in our carefully crafted cofee, 
                        made from ethically sourced beans and brewed to perfection.</motion.p>
                        <motion.div 
                     initial={{opacity:0,x:-70}}
                     whileInView={{opacity:1,x:0}}
                     transition={{duration:1.4, delay:0.8}} className='flex gap-7'>
            ...
            <div className='relative'>
                <motion.img 
                     ...
                     transition={{duration:1.5, delay:0.5}} src={coffee} className='w-[500px]' alt="" />
            </div>
           <motion.img 
                 initial={{opacity:0,x:400,scale:0.7}}
                 whileInView={{opacity:1,x:0,scale:1,rotate:45}}
                 transition={{duration:1.8, delay:0.8}} src={Bean2} className='absolute hidden
                  md:block bottom-0 left-36 x-10 w-20 rotate-45' alt="" />
           <motion.img 
                 initial={{opacity:0,x:600,y:200,scale:0.7}}
                 whileInView={{opacity:1,x:0,y:0,scale:1}}
                 transition={{duration:1.8, delay:0.8}} src={Bean1} className='absolute hidden md:block top-14 left-0 w-20' alt="" />
           <motion.img 
                initial={{opacity:0,x:-100,y:100,scale:0.7}}
                whileInView={{opacity:1,x:0,y:0,scale:1,rotate:45}}
                transition={{duration:1.8, delay:0.8}} src={Bean2} className='absolute hidden
                 md:block w-20 top-0 right-0 -rotate-45' alt="" />
        </div>
    </div>
  )
}
